...
outputFolder = fullfile(scriptDir, 'results', 'exseq_expression');
...
function T = cleanInputTable(T, useCellTypes)
    ...
    %   inner_DG  -> Hilus
    %   upper_CA1 -> SO
    %   unassigned and under_DG are excluded from the analysis
    ...
    if any(excludeRegionRows)
        fprintf("Excluding %d rows from regions: unassigned / under_DG\n", ...
